...
public class MemberInstrumentAccessor extends StaticInstrumentAccessor
{
    public MemberInstrumentAccessor(String name, Class<?> type, Function<Object, ?> getter, BiConsumer<Object, Object> setter)
    {
